...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Most clients see their first leads within 24-48 hours of their campaign going live. We can have your landing page built and ads running in as little as a few hours, so you could be getting calls the same day you sign up.",
  },
  {
  ...
  },
  {
    ...
    answer: "We work with over 60 industries including construction, motor trade, trades, cleaning, beauty, legal, and many more. Whether you're a plasterer, mechanic, electrician, or driving instructor, we have proven campaigns ready to generate leads for your specific trade.",
  },
  {
    question: "How many leads will I get?",
    answer: "We're the only lead generation company that tells you upfront how many leads to expect based on your budget and area. During your consultation, we'll give you a clear forecast so you know exactly what to expect before you commit.",
  },
  {
