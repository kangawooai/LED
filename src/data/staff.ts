...
export const staff: StaffMember[] = [
  ...
  },
  {
    slug: "robert-otoole",
    name: "Robert O'Toole",
    bio: "Originally from Dublin, Robert's background is firmly rooted in life on site. Before joining Leads Every Day, he spent years working on major construction jobs, specialising in piling and steelworks. He was a foreman too, so he knows exactly what it's like being out in all weathers, getting the job done. That experience means he gets where our customers are coming from, and it shows in how he approaches every conversation.\n\nAs our Sales Manager, Robert's the man to talk to when it comes to growing your business through smart, no-nonsense leads. He's a straight-talker, easy to get on with, and always up for a laugh, one of the most popular characters in the office. Away from work, Robert's a big family man. He heads back to Dublin whenever he can (usually managing to \"split the G\" while he's there). And in a past life? He was a keen boxer, with an impressive amateur record to prove it.",
    image: "/Rob.png",
    videos: [
      "https://www.youtube.com/watch?v=_O6iJpdE0zA",
    ],
  },
  {
    slug: "dan-feltham",
    name: "Dan Feltham",
    bio: "Dan Feltham, with years of experience within various trades he knows what the company needs. You may disagree, however with a personal 4.8* on trust pilot you can't argue with results!",
    image: "/Dan.png",
  },
  {
    slug: "kameron-james-bowen",
    name: "Kameron James-Bowen",
    bio: "Meet Kameron, a key member of the Leads Everyday team since 2018. His passion for speed and performance, both on and off the racetrack, defines his character. Kameron's love for motorsport has driven him to excel, even in the virtual world of racing simulators.\n\nKameron's impact extends beyond his personal interests. He's been instrumental in our Remapping Network's success, using his expertise to empower Remapping and Performance specialists nationwide. Today, Kameron leads The Motor Trade Network, dedicated to making independent garages more profitable and guiding them to maximize their returns through years of accumulated experience.\n\nHowever, as a devout Newcastle fan, it's safe to say his enthusiasm for performance stops with Motorsport...",
    image: "/Kameron.png",
    videos: [
      "https://www.youtube.com/watch?v=cM_un-Ljwyc",
      "https://www.youtube.com/watch?v=zLClDvZGy1k",
      "https://www.youtube.com/watch?v=Nhhpa1_-5_A",
      "https://www.youtube.com/watch?v=MAmSI6PvunI",
      "https://www.youtube.com/watch?v=pz19f6uH5ss",
      "https://www.youtube.com/watch?v=6iTIdBDLj8M",
      "https://www.youtube.com/watch?v=_rTMXAQGobs",
      "https://www.youtube.com/watch?v=_d86CS0tYe0",
      "https://www.youtube.com/watch?v=L5p33G3duLM",
      "https://www.youtube.com/watch?v=g9qKlOJ8sFQ",
      "https://www.youtube.com/watch?v=pq2EbzGfAEk",
      "https://www.youtube.com/watch?v=4K0iCs6DrLQ",
    ],
  },
  {
